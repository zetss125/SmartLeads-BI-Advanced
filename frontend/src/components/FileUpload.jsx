...
export default function FileUpload({ onUploadComplete }) {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
      <div 
        className={`relative flex flex-col items-center justify-center p-12 border-2 border-dashed rounded-3xl transition-colors ${dragActive ? 'border-emerald-500 bg-emerald-50/50 dark:bg-emerald-500/10' : 'border-slate-300 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800/50'}`}
      ...
      >
        ...
        {!file ? (
          <>
            ...
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Upload Dataset</h3>
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400 text-center max-w-xs">
              Drag and drop your social media engagement data here, or click to browse.
            </p>
            <p className="mt-1 text-xs text-slate-400">Supports CSV, JSON, Excel (.xlsx)</p>
